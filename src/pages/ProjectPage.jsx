...
import { projects } from '../components/uicomponents/CardHoverEffect'
...
export default function ProjectPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-800 via-gray-900 to-black text-gray-100 py-12">
      ...
      <h3 className="text-center text-xl sm:text-4xl lg:text-xl font-extrabold leading-tight mb-12 ">Here are a few project i've worked on recently</h3>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-8 px-6 lg:px-12">
        ...
        <div className='mx-[150px] my-10 '><HireME /></div>
